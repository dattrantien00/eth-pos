...
MainnetSetting = BaseChainSetting(
    ...
    GENESIS_VALIDATORS_ROOT=bytes.fromhex('698811727c2b02c943c144b8dff167731ad59c36a084f14c0ea31bcca8ee8a6d'))
# Goerli setting
GoerliSetting = BaseChainSetting(
    NETWORK_NAME=GOERLI, GENESIS_FORK_VERSION=bytes.fromhex('00001031'),
...
TestnetSetting = BaseChainSetting(
    NETWORK_NAME=TESTNET, GENESIS_FORK_VERSION=bytes.fromhex('20000089'),
    GENESIS_VALIDATORS_ROOT=bytes.fromhex('fa27c7795d870930c36f82b8b5975ac22043f751b90f0fcf60d92b3904f25bfe'))
