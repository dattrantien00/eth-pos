...
GETH_BINARY=./dependencies1/go-ethereum/build/bin/geth
GETH_BOOTNODE_BINARY=./dependencies1/go-ethereum/build/bin/bootnode
PRYSM_CTL_BINARY=./dependencies1/prysm/out/prysmctl
PRYSM_BEACON_BINARY=./dependencies1/prysm/out/beacon-chain
PRYSM_VALIDATOR_BINARY=./dependencies1/prysm/out/validator
...
--deposit-json-file=./deposit_account/account0/validator_keys/deposit_data.json
...
#       --rpc-port=$((PRYSM_VALIDATOR_RPC_PORT + 0)) \
#       --grpc-gateway-port=$((PRYSM_VALIDATOR_GRPC_GATEWAY_PORT + i0)) \
#       --monitoring-port=$((PRYSM_VALIDATOR_MONITORING_PORT + 0)) \
#       --graffiti="node-0" \
#       --proposer-settings-file=./validator0.json \
#       --chain-config-file=$NODE_DIR/consensus/config.yml > "$NODE_DIR/logs/validator.log" 2>&1 &
